...
//
//  Created by Mark Powell on 9/11/20.
//  Copyright © 2020 Mark Powell. All rights reserved.
//
...
public class MarsTimeConversion {
    ...
    /* TABLE OF LEAP SECONDS: ftp://maia.usno.navy.mil/ser7/tai-utc.dat
     ...
     from https://help.agi.com/AGIComponentsJava/Javadoc/agi-foundation-time-LeapSecondFile.html
    ...
    fileprivate static func taiutc(_ date:Date) -> (Double) {
        ...
        else if julianDate >= 2457204.5 {
            return 36.0
        }
        else if julianDate >= 2456109.5 {
            return 35.0
        }
